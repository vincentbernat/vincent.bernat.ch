(function () {
  ...
  define("app/i18n", ["app/config", "app/i18n/en", "app/i18n/fr"], function (
    config,
    en,
    fr
  ) {
  ...
  define("jade!app/text/postbox", function () {
    var wfn = function (jade) {
      var fn = function template(locals) {
        ...
        (function (author, email, i18n, website) {
          buf.push(
            '<div class="isso-postbox"><div class="form-wrapper"><div class="textarea-wrapper"><div contenteditable="true" class="textarea placeholder">' +
              jade.escape(
                null == (jade_interp = i18n("postbox-text")) ? "" : jade_interp
              ) +
              '</div><div class="preview"><div class="isso-comment"><div class="text-wrapper"><div class="text"></div></div></div></div></div><section class="auth-section"><p class="input-wrapper"><input type="text" name="author"' +
              jade.attr("placeholder", i18n("postbox-author"), true, false) +
              jade.attr(
                "value",
                author !== null ? "" + author + "" : "",
                true,
              ...
              '/></p><p class="input-wrapper"><input type="email" name="email"' +
              jade.attr("placeholder", i18n("postbox-email"), true, false) +
              jade.attr(
                "value",
                email != null ? "" + email + "" : "",
                true,
              ...
              '/></p><p class="input-wrapper"><input type="text" name="website"' +
              jade.attr("placeholder", i18n("postbox-website"), true, false) +
              jade.attr(
                "value",
              ...
              '/></p><p class="post-action"><input type="submit"' +
              jade.attr("value", i18n("postbox-submit"), true, false) +
              '/></p><p class="post-action"><input type="button" name="preview"' +
              jade.attr("value", i18n("postbox-preview"), true, false) +
              '/></p><p class="post-action"><input type="button" name="edit"' +
              jade.attr("value", i18n("postbox-edit"), true, false) +
              '/></p></section><section class="notification-section"><label><input type="checkbox" name="notification"/>' +
              jade.escape(
                null == (jade_interp = i18n("postbox-notification"))
                  ? ""
                  : jade_interp
              ) +
          ...
          "i18n" in locals_for_with
            ...
            ? i18n
            : undefined,
          "website" in locals_for_with
            ? locals_for_with.website
  ...
  define("jade!app/text/comment", function () {
    var wfn = function (jade) {
      var fn = function template(locals) {
        ...
        var jade_interp;
        var locals_for_with = locals || {};
        (function (bool, comment, conf, datetime, humanize, i18n, svg) {
          buf.push(
            "<div" +
              jade.attr("id", "isso-" + comment.id + "", true, false) +
              ' class="isso-comment">'
          );
          if (conf.gravatar) {
            buf.push(
          ...
          if (conf.avatar) {
            buf.push(
              '<div class="avatar"><svg' +
                jade.attr("data-hash", "" + comment.hash + "", true, false) +
                "></svg></div>"
            );
          }
          buf.push(
            '<div class="text-wrapper"><div role="meta" class="isso-comment-header">'
          );
          if (bool(comment.website)) {
            buf.push(
              "<a" +
                jade.attr("href", "" + comment.website + "", true, false) +
                ' rel="nofollow" class="author">' +
                jade.escape(
                  null ==
                    (jade_interp = bool(comment.author)
                      ? comment.author
                      : i18n("comment-anonymous"))
                    ? ""
                    : jade_interp
                ) +
                "</a>"
          ...
          buf.push(
            '<span class="spacer">&bull;</span><a' +
              jade.attr("href", "#isso-" + comment.id + "", true, false) +
              ' class="permalink"><time' +
              jade.attr(
                "title",
          ...
          if (conf.vote) {
            buf.push(
              '<a href="#" class="upvote">' +
                (null == (jade_interp = svg["arrow-up"]) ? "" : jade_interp) +
                '</a><span class="spacer">|</span><a href="#" class="downvote">' +
                (null == (jade_interp = svg["arrow-down"]) ? "" : jade_interp) +
                "</a>"
            );
          }
          buf.push(
            '<a href="#" class="reply">' +
              jade.escape(
                (jade_interp = i18n("comment-reply")) == null ? "" : jade_interp
              ) +
              '</a><a href="#" class="edit">' +
              jade.escape(
                (jade_interp = i18n("comment-edit")) == null ? "" : jade_interp
              ) +
              '</a><a href="#" class="delete">' +
              jade.escape(
                (jade_interp = i18n("comment-delete")) == null
                  ? ""
                  : jade_interp
              ) +
              '</a></div><div class="isso-follow-up"></div></div></div>'
          );
        }.call(
          this,
          "bool" in locals_for_with
            ? locals_for_with.bool
            : typeof bool !== "undefined"
            ? bool
            : undefined,
          "comment" in locals_for_with
            ? locals_for_with.comment
            : typeof comment !== "undefined"
            ? comment
            : undefined,
          "conf" in locals_for_with
            ? locals_for_with.conf
            : typeof conf !== "undefined"
            ? conf
            : undefined,
          "datetime" in locals_for_with
            ? locals_for_with.datetime
            : typeof datetime !== "undefined"
            ? datetime
            : undefined,
          "humanize" in locals_for_with
            ? locals_for_with.humanize
            : typeof humanize !== "undefined"
            ? humanize
            : undefined,
          "i18n" in locals_for_with
            ? locals_for_with.i18n
    ...
    var wfn = function (jade) {
      var fn = function template(locals) {
        ...
        (function (comment, pluralize) {
          buf.push(
            "<div" +
              jade.attr("id", "isso-loader-" + comment.name + "", true, false) +
              ' class="isso-comment-loader"><a href="#" class="load_hidden">' +
              jade.escape(
                (jade_interp = pluralize(
                  "comment-hidden",
                  comment.hidden_replies
                )) == null
                  ? ""
                  : jade_interp
              ) +
          ...
          "comment" in locals_for_with
            ...
            ? comment
            : undefined,
          "pluralize" in locals_for_with
            ? locals_for_with.pluralize
            : typeof pluralize !== "undefined"
            ? pluralize
            : undefined
        ));
        return buf.join("");
...
*/
  define("app/lib/identicons", ["app/lib/promise", "app/config"], function (
    Q,
    config
  ) {
    "use strict";
  ...
  define("app/isso", [
    ...
    var Postbox = function (parent) {
      ...
      $("[name='preview']", el).on("click", function () {
        api
          .preview(utils.text($(".textarea", el).innerHTML))
          .then(function (html) {
    ...
    var insert_loader = function (comment, lastcreated) {
      ...
      if (comment.id === null) {
        ...
        entrypoint = $(
          "#isso-" + comment.id + " > .text-wrapper > .isso-follow-up"
        );
  ...
  require([
    ...
    "app/text/svg",
    "app/jade",
  ], function (domready, config, i18n, api, isso, $, svg, jade) {
    "use strict";
